...
public class BHTPvZBlocks {
    ...
    public static final RegistryObject<Block> ORIGIN_MUSHROOM_BLOCK = BLOCKS.register("origin_mushroom_block", ()-> new Block(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_GREEN).harvestLevel(2).strength(0.6f, 1.0f).sound(SoundType.WOOD))); // 原始蘑菇块
    ...
    public static final RegistryObject<Block> MORION_ORE = BLOCKS.register("morion_ore", ()-> new OreBlock(Block.Properties.of(Material.STONE).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(3.0f, 3.0f).requiresCorrectToolForDrops())); // 黑晶矿
    ...
    public static final RegistryObject<DoorBlock> SCREEN_DOOR  = BLOCKS.register("screen_door", () -> new ScreenDoorBlock((Block.Properties.of(Material.METAL, MaterialColor.METAL).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(15.0f, 15.0f).sound(SoundType.METAL).requiresCorrectToolForDrops().noOcclusion()))); //钢门
