...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> STEEL_PUMPKIN  = BLOCKS.register("steel_pumpkin", () -> new Block((AbstractBlock.Properties.of(Material.PLANT, MaterialColor.METAL).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(15.0F, 15.0F).sound(SoundType.METAL).requiresCorrectToolForDrops())));//钢南瓜
