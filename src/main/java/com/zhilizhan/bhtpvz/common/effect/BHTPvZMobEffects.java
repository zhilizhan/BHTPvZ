...
public class BHTPvZMobEffects {
    ...
    public static final RegistryObject<Effect> HALITOSIS = MOB_EFFECTS.register("halitosis", () -> new HalitosisEffect(EffectType.BENEFICIAL, 7259200));// 口臭buff
    public static final RegistryObject<Effect> GOO_POISON = MOB_EFFECTS.register("goo_poison", () -> new GooPoisonEffect(EffectType.HARMFUL, 15350204).addAttributeModifier(Attributes.MOVEMENT_SPEED,
