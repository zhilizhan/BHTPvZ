...
public class BHPvZChestLootTables  implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
    ...
    public void accept(BiConsumer<ResourceLocation, Builder> t) {
        t.accept(PVZLoot.DAVE_VILLA_CHEST, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(RandomValueRange.between(3.0F, 5.0F))
                        ...
                        .add(ItemLootEntry.lootTableItem(ItemRegister.POTATO_MINE_ENJOY_CARD.get()).setWeight(7))
                        .add(ItemLootEntry.lootTableItem(BHTPvZItems.GRASS_CARP_ENJOY_CARD.get()).setWeight(4))
                        .add(ItemLootEntry.lootTableItem(BHTPvZItems.SCULK_SHROOM_ENJOY_CARD.get()).setWeight(8))
        ...
        t.accept(PVZLoot.BUCKET_HOUSE_CHEST, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(RandomValueRange.between(2.0F, 4.0F))
                        ...
                        .add(ItemLootEntry.lootTableItem(ItemRegister.POTATO_MINE_ENJOY_CARD.get()).setWeight(7).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
                        .add(ItemLootEntry.lootTableItem(BHTPvZItems.GRASS_CARP_ENJOY_CARD.get()).setWeight(4).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
                        .add(ItemLootEntry.lootTableItem(Items.BOOK).setWeight(20).apply(EnchantRandomly.randomApplicableEnchantment()))
                        .add(ItemLootEntry.lootTableItem(Items.GOLDEN_APPLE).setWeight(20))
                        .add(ItemLootEntry.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(2))
                        .add(EmptyLootEntry.emptyItem().setWeight(15)))
        ...
        t.accept(PVZLoot.DOLPHIN_HOUSE_CHEST, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(RandomValueRange.between(2.0F, 4.0F))
                        ...
                        .add(ItemLootEntry.lootTableItem(ItemRegister.POTATO_MINE_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
                        .add(ItemLootEntry.lootTableItem(BHTPvZItems.GRASS_CARP_ENJOY_CARD.get()).setWeight(8).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
                        .add(ItemLootEntry.lootTableItem(Items.BOOK).setWeight(20).apply(EnchantRandomly.randomApplicableEnchantment()))
                        .add(ItemLootEntry.lootTableItem(Items.GOLDEN_APPLE).setWeight(20))
                        .add(ItemLootEntry.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(2))
                        .add(EmptyLootEntry.emptyItem().setWeight(15)))
        ...
        t.accept(PVZLoot.GRAVE_YARD_CHEST, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(RandomValueRange.between(2.0F, 4.0F))
                        ...
                        .add(ItemLootEntry.lootTableItem(ItemRegister.POTATO_MINE_ENJOY_CARD.get()).setWeight(12).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
                        .add(ItemLootEntry.lootTableItem(BHTPvZItems.GRASS_CARP_ENJOY_CARD.get()).setWeight(8).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
